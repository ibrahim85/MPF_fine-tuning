...
def sampleIMAGES(patchsize, dataset):
    ...
    if dataset == 'training':
        ...
        patches = IMAGES[0:patchsize*patchsize, 0:numpatches]
    elif dataset == 'testing':
        IMAGES = load_images('t10k-images-idx3-ubyte')
        print(IMAGES.shape)
        Labels = load_labels('t10k-labels-idx1-ubyte')
        numpatches = 10000
        labels = Labels[0:numpatches]
        patches = IMAGES[0:patchsize*patchsize, 0:numpatches]
    ## ---------- YOUR CODE HERE --------------------------------------
...
if __name__ == "__main__":
    ...
    #displayNetwork(W21.T,saveName='weights_2.png')
    #display_network(W21)
    # ======================================================================
    ...
    #
    # numgrad = computeNumericalGradient(lambda x: finetuning(x,patches,labels,decayWeight,
    #                                     hiddenSizeL1,hiddenSizeL2,visibleSize,numClasses)[0],theta)
    #
    ...
    thetaSoftmax, W11, W21, b11, b21 = unravelDeepParameters(opttheta,visibleSize,hiddenSizeL1,hiddenSizeL2,numClasses)

    #displayNetwork(W11.T,saveName='weights_3.png')
    ...
    correctness = predictFinetuning(opttheta,data,label,visibleSize,hiddenSizeL1,hiddenSizeL2,numClasses)

    print(correctness)

    display_network(W11)
    # print(W21.T.shape)
    displayNetwork(W21.T,saveName='weights_4.png')

    #0.8833 before finetuning
    #finetuning achieve 0.976