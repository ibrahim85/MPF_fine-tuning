...
class np_dmpf_optimizer(object):
    ...
    def get_cost_updates(self, theta, data, sample_prob):
...
def train_bfgs_rbm(epsilon,n_samples,epoches):
    ...
    for i in range(num_patches):
        ...
        patches[i,:] = patches[i,:] + \
                       Images[pix_index[0]:pix_index[0]+8,pix_index[1]:pix_index[1]+8,im_index].reshape(1,64)
    ...
    for i in range(epoches):
        ...
        saveName = 'weights_' + str(n_samples) + '_' + str(epsilon) + '_' + str(epoches) + '.png'
