...
class AE(object):
    ...
    def get_cost_updates(self,learning_rate):
        ...
        if self.missing:
            ...
            mean_activation = (mean_activation.T/self.norm_indi).T
...
if __name__ == '__main__':
    ...
    dataset1 = '../Data/train_HumIllum_trunc.npy'
    validationset1 = '../Data/test_HumIllum_trunc.npy'
    ...
    for j in range(len(hidden_list)):
        ...
        for i in range(len(a)):
            missingrate = a[i]
            print(missingrate)
            test_AE(dataset,validationset, param_list,n_hidden =n_hidden1,share= True,missing = True,
            missing_rate = missingrate,learning_rate=0.1, training_epochs= 1000,
            batch_size= 30, output_folder='ae_concatenate_linear_10',order = 1)
        ...
        for i in range(len(b)):
            ...
            test_AE(dataset,validationset, param_list,n_hidden = n_hidden1,share= True,missing = True,
            missing_rate = missingrate,learning_rate=0.1, training_epochs= 1000,
            batch_size= 120, output_folder='ae_concatenate_linear_10',order = 1)
        ...
        for i in range(len(c)):
            ...
            test_AE(dataset,validationset, param_list,n_hidden = n_hidden1,share= True,missing = True,
            missing_rate = missingrate,learning_rate=0.1, training_epochs= 1000,
            batch_size= 300, output_folder='ae_concatenate_linear_10',order = 1)
    ...
    for j in range(len(hidden_list)):
        ...
        for i in range(len(a)):
            missingrate = a[i]
            print(missingrate)
            test_AE(dataset,validationset, param_list,n_hidden =n_hidden1,share= False,missing = True,
            missing_rate = missingrate,learning_rate=0.1, training_epochs= 1000,
            batch_size= 30, output_folder='ae_single_mod_linear_10',order = 1)
        ...
        for i in range(len(b)):
            ...
            test_AE(dataset,validationset, param_list,n_hidden = n_hidden1,share= False,missing = True,
            missing_rate = missingrate,learning_rate=0.1, training_epochs= 1000,
            batch_size= 120, output_folder='ae_single_mod_linear_10',order = 1)
        ...
        for i in range(len(c)):
            ...
            test_AE(dataset,validationset, param_list,n_hidden = n_hidden1,share= False,missing = True,
            missing_rate = missingrate,learning_rate=0.1, training_epochs= 1000,
            batch_size= 300, output_folder='ae_single_mod_linear_10',order = 1)
